...
with st.expander(
    "📖 Gestione Avanzata Banca Dati Alimenti", expanded=False
):
    ...
    with st.form("form_inserimento_manuale"):
        ...
        if btn_submit_manuale:
            if nuovo_nome.strip() == "":
                ...
                salva_dati_disco()  # Salvataggio su file
                st.success(
                ...
                if df_nuovo is not None and not df_nuovo.empty:
                    ...
                    if st.button("Conferma e Aggiungi alla Banca Dati"):
                        ...
                        for c in df_nuovo.columns:
                            ...
                            elif "gr" in c or "quant" in c or "peso" in c:
                        ...
                        if len(presenti) >= 4:
                            ...
                            st.error(
                                "Il formato del file CSV non contiene abbastanza colonne valide."
                            )
            except Exception as e:
