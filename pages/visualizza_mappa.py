...
def get_coordinates_from_json(url):
    """Scarica il JSON e formatta correttamente le coordinate scambiando lat e lon"""
    try:
        ...
        if response.status_code == 200:
            ...
            # Se i dati sono una lista piatta, invertiamo l'assegnazione delle colonne lat/lon
