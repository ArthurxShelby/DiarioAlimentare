...
def fetch_activity_map(activity_id, api_key):
    """
    Recupera i dati della mappa/tracciato da Intervals.icu per l'attività specifica.
    """
...
def upload_map_to_supabase(activity_id, map_data):
    """
    Gestisce l'upload dei dati della mappa su Supabase Storage e restituisce l'URL pubblico.
    """
    if not map_data:
        return None
