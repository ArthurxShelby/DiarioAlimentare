...
# --- 3. CONTENITORE GRAFICI INTERATTIVI E DETTAGLIO USCITE SOTTO UN MENU A TENDINA (EXPANDER) ---
st.markdown("---")

with st.expander("📈 Analisi Grafica e Dettaglio Uscite per Metrica", expanded=True):
