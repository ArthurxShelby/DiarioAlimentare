...
# --- 2. ESPLORATORE STORICO ON-DEMAND DA INTERVALS (Persistenza Reale) ---

# Inizializziamo la chiave solo se non è mai stata creata prima
...
with st.expander("🔍 Esplora Archivio Storico da Intervals (Range Personalizzato)", expanded=False):
    ...
    with col_c1:
        # Usando direttamente la key senza parametro 'value', Streamlit mantiene 
        # automaticamente l'ultimo valore scelto ed evita di resettarlo al default.
